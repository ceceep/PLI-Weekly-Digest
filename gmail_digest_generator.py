"""
Email digest generator using Gmail SMTP (simpler alternative to SendGrid)
"""
import os
import smtplib
...
"""
    ...
    def send_weekly_digest(self):
        ...
        print(f"Weekly digest sent to {success_count}/{len(recipient_emails)} subscribers")
...
"""
        ...
        print(f"Daily reminder sent to {success_count}/{len(recipient_emails)} subscribers")
